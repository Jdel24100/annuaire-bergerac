import svgPaths from "./svg-kqgsdpx7fe";
  ...
  return (
    <div className="relative size-full" data-name="Container">
      <div className="max-w-inherit min-w-inherit size-full">
        <div className="box-border content-stretch flex flex-col items-start max-w-inherit min-w-inherit px-[16px] py-0 relative size-full">
          <Container2 />
        </div>
      </div>
    </div>
