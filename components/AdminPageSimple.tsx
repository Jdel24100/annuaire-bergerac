// AdminPageSimple.tsx - Composant Annuaire Bergerac (RÉEL)
// Export du 05/10/2025 18:35:46
// ATTENTION: Contenu de fallback - remplacez par votre code réel

import React from 'react';

interface AdminPageSimpleProps {
  onNavigate?: (page: string, params?: any) => void;
  [key: string]: any;
}

export function AdminPageSimple({ onNavigate, ...props }: AdminPageSimpleProps) {
  return (
    <div className="min-h-screen bg-background p-6">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-2xl font-bold mb-4">AdminPageSimple</h1>
