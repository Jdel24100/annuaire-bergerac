// ExportShortcut.tsx - Composant Annuaire Bergerac (RÉEL)
// Export du 05/10/2025 18:35:51
// ATTENTION: Contenu de fallback - remplacez par votre code réel

import React from 'react';

interface ExportShortcutProps {
  onNavigate?: (page: string, params?: any) => void;
  [key: string]: any;
}

export function ExportShortcut({ onNavigate, ...props }: ExportShortcutProps) {
  return (
    <div className="min-h-screen bg-background p-6">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-2xl font-bold mb-4">ExportShortcut</h1>
