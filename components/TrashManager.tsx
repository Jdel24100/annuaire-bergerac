// TrashManager.tsx - Composant Annuaire Bergerac (RÉEL)
...
export function TrashManager({ onNavigate, ...props }: TrashManagerProps) {
  return (
    <div className="min-h-screen bg-background p-6">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-2xl font-bold mb-4">TrashManager</h1>
