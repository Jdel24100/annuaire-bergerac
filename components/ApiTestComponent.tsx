// ApiTestComponent.tsx - Composant Annuaire Bergerac (RÉEL)
...
export function ApiTestComponent({ onNavigate, ...props }: ApiTestComponentProps) {
  return (
    <div className="min-h-screen bg-background p-6">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-2xl font-bold mb-4">ApiTestComponent</h1>
