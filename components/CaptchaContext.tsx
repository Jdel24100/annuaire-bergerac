// CaptchaContext.tsx - Composant Annuaire Bergerac (RÉEL)
// Export du 05/10/2025 18:35:50
...
export function CaptchaContext({ onNavigate, ...props }: CaptchaContextProps) {
  return (
    <div className="min-h-screen bg-background p-6">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-2xl font-bold mb-4">CaptchaContext</h1>
